<%@ include file="header.jsp" %>
	...
	<section class="home" id="home">
		<div class="content">
			<h1>Stay Healthy Stay Safe</h1>
			<p>All Doctors treat,but a good doctor lets nature heal</p>
			<a href="appointmentform.jsp" class="btn">Make An Appointment</a>
	...
	<section class="about" id="about">
		...
		<div class="row">
			...
			<div class="content">
				...
				<a href="aboutus.jsp" class="btn"> learn more <span
		...
		<div class="box-container">
			...
			<div class="box">
				...
				<p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ad,
					omnis.</p>
				<a href="services.jsp" class="btn"> learn more <span
					class="fas fa-chevron-right"></span>
				</a>
			</div>
	...
	<section class="doctor" id="doctor">
		...
		<div class="box-container">
			<div class="box">
				...
				<div class="content">
					<h3>Jhon Deo</h3>
					<p>Expert Doctors in blood Cancer</p>
					<a href="doctors.jsp" class="btn">See more</a>
				</div>
			</div>
